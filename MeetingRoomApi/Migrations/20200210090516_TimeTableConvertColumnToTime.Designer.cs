...
namespace MeetingRoomApi.Migrations
{
    ...
    [Migration("20200210090516_TimeTableConvertColumnToTime")]
    partial class TimeTableConvertColumnToTime
    {
            ...
            modelBuilder.Entity("MeetingRoomApi.Models.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = (short)1,
                            Name = "Receb",
                            Password = "$2b$10$IfeEDCb/S9oFLTH1jQAY1uS3rBwnkYK3ndh6Dar9EhOG5L1jLHAxe",
                            Surname = "Qarayev",
                            UserName = "Rajab97"
                        },
                        new
                        {
                            Id = (short)2,
                            Name = "Test",
                            Password = "$2b$10$1KHAxfxD/BGc8RjEFPCTZOQxhijWBklQMjsmsBLi5TKDlppBBv.KC",
                            Surname = "Test",
                            UserName = "Test123"
                        });
                });
