...
namespace MeetingRoomApi.Migrations
{
    ...
    [Migration("20200221133525_validTimesSeeding")]
    partial class validTimesSeeding
    {
            ...
            modelBuilder.Entity("MeetingRoomApi.Models.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = (short)1,
                            Name = "Receb",
                            Password = "$2b$10$SdT01AXDDwwoCziD1HLVD.Eng4rvAWTw6ScCaus3ks5VWVIJ1yJ.m",
                            Surname = "Qarayev",
                            UserName = "Rajab97"
                        },
                        new
                        {
                            Id = (short)2,
                            Name = "Test",
                            Password = "$2b$10$wX63IcePaEsC4dsybJOBouFIGIXbJTlH1CZVyXTXpjr4tJa11NP9u",
                            Surname = "Test",
                            UserName = "Test123"
                        });
                });
